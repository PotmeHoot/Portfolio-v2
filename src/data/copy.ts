 ...
 * This structure allows for easy localization in the future.
 */
...
export const copy = {
  common: {
    ...
    specialization: "Social Content, Motion & AI",
    cta: "Let's collaborate",
    viewWork: "View selected work",
    comingSoon: "Coming Soon",
    assetPending: "Asset Pending",
    agency: "Agency",
    client: "Client",
  ...
  services: {
    ...
    items: [
      ...
      },
      {
        id: "ar",
        title: "AR Filters",
        description: "Interactive Augmented Reality experiences for Instagram and TikTok that boost brand interaction.",
        icon: "Sparkles"
      }
    ]
  },
  collaboration: {
    title: "How I Work",
    description: "A structured approach to delivering high-quality creative assets.",
    steps: [
      {
        id: "brief",
